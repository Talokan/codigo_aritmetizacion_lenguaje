...
def regresaContenidoFormulaSiEsNegacionSiNoLaMisma(lista):
    nuevaLista = []
    if(lista[0]==9 and lista[1]==3 and lista[-1]==5):
        for k in range(2, len(lista)-1):
...
nuevaLista = regresaContenidoFormulaSiEsNegacionSiNoLaMisma(lista)  
if(verificacionSimbolosAdecuados):
    print(verificacionQueListaEsLFormulaAtomica(nuevaLista, aridades))
else:
